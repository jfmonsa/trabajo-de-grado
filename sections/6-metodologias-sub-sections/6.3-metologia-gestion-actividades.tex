...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/figures/fig9-webdesk-kaban-board.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/figures/fig10-plane-kanban-board.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/figures/fig12-telegram.png}
